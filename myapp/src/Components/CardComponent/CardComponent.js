...
const CardComponent = (props) => {
  const profilePhotos = {
    AN: 'https://img.freepik.com/free-photo/cheerful-indian-businessman-smiling-closeup-portrait-jobs-career-campaign_53876-129417.jpg?w=740&t=st=1702591678~exp=1702592278~hmac=269777e48bac0aa80469e2cab3cc908f212abf8b3245458b803c3812fa1ee167',
    YO: 'https://as2.ftcdn.net/v2/jpg/06/25/73/75/1000_F_625737580_tHUaqSY2hKO5Z8HhFpx30vrB9AiQGMwb.jpg',
    SU: 'https://t4.ftcdn.net/jpg/06/13/28/69/240_F_613286945_BJ7rUxmhftMxfNtyyfnwDwuD2CxK8YQM.jpg',
  };
  const initials = `${props.cardDetails.userObj.name[0]}${props.cardDetails.userObj.name[1]}`;

  const profilePhotoSrc = profilePhotos[initials.toUpperCase()];

  console.log("Initials:", initials);
  console.log("Profile Photo Src:", profilePhotoSrc);
        ...
        <div className="card-id-wrapper">
          ...
          <div className="card-profile">
            <div className="card-profile-photo">
              {profilePhotoSrc ? (
                <img src={profilePhotoSrc} alt={`Profile for ${props.cardDetails.userObj.name}`} />
              ) : (
